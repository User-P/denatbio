        ...
        table.on('init',function(){
            ...
            if(action=='groups')
            {
                if(can_view)
                {
                    ...
                    <a href="`+url('admin/'+action)+`/bulk/print_working_paper" class="bulk_button dropdown-item" target="_blank" warning_message=" `+trans('Are you sure to print bulk working paper ?')+`">
