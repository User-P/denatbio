      ...
      <div class="card-body p-0">
        <div class="tab-content">
          ...
          <div class="tab-pane overflow-auto" id="test_{{$test['id']}}">
            <form action="{{route('admin.medical_reports.update',$test['id'])}}" method="POST" enctype='multipart/form-data'>
              @csrf
              @method('put')
              <table class="table table-striped table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    <td colspan="5">
                      <label for="">{{ __('Imagenes prueba') }}</label>
                      <table>
                        <tr>
                          <td>
                            <label for="">{{ __('Imagen 1') }}</label>
                            <input class="form-control" type="file" name="photo1_test" accept="image/*">
                          </td>
                          <td>
                            <img src="{{url('uploads/tests/')}}/{{ $test['photo1'] }}" style="object-fit: contain;" height="100"> 
                          </td>
                          <td>
                            <label for="">{{ __('Imagen 2') }}</label>
                            <input class="form-control" type="file" name="photo2_test" accept="image/*">
                          </td>
                          <td>
                            <img src="{{url('uploads/tests/')}}/{{ $test['photo2'] }}" style="object-fit: contain;" height="100"> 
                          </td>
                        </tr>
                      </table>
                    </td>
