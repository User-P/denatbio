...
<div class="row">
    <div class="col-lg-12">
        <div class="input-group form-group mb-3">
            ...
            <select name="contracts[]" id="contracts_assign" placeholder="{{__('Contracts')}}" class="form-control select2" multiple required>
                <option value="" disabled>{{__('Select a contract')}}</option>
