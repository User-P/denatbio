...
class PatientsController extends Controller
{
    ...
    */
    public function ajax(Request $request)
    {
        ...
        $contracts_id = auth()->guard('admin')->user()->contracts->pluck('contract_id');
        $model = Patient::whereIn('contract_id', $contracts_id);

        return DataTables::eloquent($model)
        
        ->editColumn('contract',function($patient){
            return formated_price($patient['contract']['title']);
        })
    ...
    {
        $contract = Contract::find(auth()->guard('admin')->user()->contract_id);
        $contracts_admin = auth()->guard('admin')->user()->contracts;
        return view('admin.patients.create', compact('contract','contracts_admin'));
    }
