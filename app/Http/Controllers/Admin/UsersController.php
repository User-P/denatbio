...
class UsersController extends Controller
{
    ...
    */
    public function ajax(Request $request)
    {
        ...
        ->addColumn('contracts',function($user){
            return view('admin.users._contracts',compact('user'));
        })
    ...
    public function create()
    {
        ...
        return view('admin.users.create',compact('roles','branches','contracts'));
    }
    ...
    public function edit($id)
    {
        ...
        $branches=Branch::all();
        $contracts=Contract::all();
        return view('admin.users.edit',compact('user','roles','branches','contracts'));
    }
